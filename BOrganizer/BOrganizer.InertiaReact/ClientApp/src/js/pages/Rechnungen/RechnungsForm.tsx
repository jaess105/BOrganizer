            ...
            <form onSubmit={handleSubmit} className="space-y-8 p-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <select
                            id="rechnungsStellerId"
                            value={data.rechnungsStellerId}
                            onChange={(e) => setData('rechnungsStellerId', e.target.value)}
                    ...
                    <div>
                        ...
                        <select
                            id="rechnungsEmpfaengerId"
                            value={data.rechnungsEmpfaengerId}
                            onChange={(e) => setData('rechnungsEmpfaengerId', e.target.value)}
                            className="block w-full rounded-md border py-2 px-3 shadow-sm focus:border-primary focus:ring focus:ring-primary/50 focus:ring-opacity-50"
                        >
                            <option value="">Bitte wählen</option>
                            {businesses.map((b) => (
